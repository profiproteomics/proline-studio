...
public class DefaultFloatingPanel extends HourglassPanel {
    ...
    private JButton m_actionButton = null;
    ...
    public DefaultFloatingPanel(String infoText, String actionName, ActionListener a, Icon icon) {
        ...
        m_actionButton = new JButton(actionName, icon);
        m_actionButton.setMargin(new Insets(1, 1, 1, 1));
        m_actionButton.setFocusPainted(false);
        

        m_actionButton.addActionListener(a);
