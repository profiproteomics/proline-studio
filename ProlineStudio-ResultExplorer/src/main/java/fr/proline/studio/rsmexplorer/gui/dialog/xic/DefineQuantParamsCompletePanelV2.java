 ...
 * @author VD225637
 */
public class DefineQuantParamsCompletePanelV2 extends AbstractDefineQuantParamsPanelV2 {
    ...
    public DefineQuantParamsCompletePanelV2(boolean readOnly, boolean readValues) {
        super(readOnly);
    ...
    /**
     * set the quanti params.  This method assume parameters are formated as V2 Params
     * @param quantParams 
     */
    public void setQuantParams(Map<String,Object>  quantParams){
        ...
        if(quantParams.containsKey("alignment_config")) {
            ...
            m_alignmentMethodParameter.setValue((String) alignmentConfig.getOrDefault("method_name", ALIGNMENT_METHOD_VALUES[0]));
