...
public class DisplayRsetPeptidesAction extends AbstractRSMAction {
   ...
   public DisplayRsetPeptidesAction() {
       super(NbBundle.getMessage(DisplayRsetPeptidesAction.class, "CTL_DisplayPeptidesAction"), RSMTree.TreeType.TREE_IDENTIFICATION);
   }
    ...
    private void actionImpl(RSMDataSetNode dataSetNode) {
        ...
        if (rset != null) {
            ...
            // prepare window box
            WindowBox wbox = (hasResultSummary) ? WindowBoxFactory.getPeptidesWindowBox(dataSet.getName()+" PSM", false) : WindowBoxFactory.getPeptidesForRsetOnlyWindowBox(dataSet.getName()+" PSM", false);
