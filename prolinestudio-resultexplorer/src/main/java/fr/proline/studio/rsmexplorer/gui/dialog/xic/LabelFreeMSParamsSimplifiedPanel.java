...
public class LabelFreeMSParamsSimplifiedPanel extends AbstractLabelFreeMSParamsPanel {
    ...
    /**
     * set the quantitation params. This method assume parameter are formatted
     * as V2 Params Some params, not be visible here, may not be taken into
     * account ....
     *
     * @param quantParams
     */
    ...
    private void enableCrossAssignment(boolean isEnabled) {
        if (m_crossAssignSettingsPanel == null) {
            createCrossAssignmentPanel();
        }
