...
public class PanelPeptidesPTMSiteAll extends JPanel implements DataBoxPanelInterface {
    ...
    /**
     * in AbstractDataBox protected void
     * setDataBoxPanelInterface(DataBoxPanelInterface panelInterface) { m_panel
     * = panelInterface; if (m_panel != null) {
     * getDataBoxPanelInterface().addSingleValue(m_projectId); } } so the v is
     * projetId
     *
     * @param v
     */
    ...
    static public int SOURCE_TABLE = 0;
