...
public class DisplayRsmPeptidesAction extends AbstractRSMAction {
   ...
   public DisplayRsmPeptidesAction(TreeType treeType) {
       super(NbBundle.getMessage(DisplayRsmPeptidesAction.class, "CTL_DisplayRsmPeptidesAction"), treeType);
   }
    ...
    private void actionImpl(DataSetNode dataSetNode) {
        ...
        if (rsm != null) {
            ...
            // prepare window box
            WindowBox wbox = WindowBoxFactory.getRsmPeptidesWindowBox(dataSet.getName()+" Peptides", false);
            ...
            final WindowBox wbox = WindowBoxFactory.getRsmPeptidesWindowBox(dataSet.getName()+" Peptides", false);
            // open a window to display the window box
            DataBoxViewerTopComponent win = new DataBoxViewerTopComponent(wbox);
            win.open();
            win.requestActive();
