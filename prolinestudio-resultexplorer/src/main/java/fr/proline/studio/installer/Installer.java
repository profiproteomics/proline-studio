...
//            productVersion = moduleVersion.substring(0, secIndex);
        ...
        String buildnumber = isSnapshot ? productVersion+" Milestone ("+moduleBuildDate+")" : productVersion; //specify if Milestone, Release Candidate or release (or nothing = release)
