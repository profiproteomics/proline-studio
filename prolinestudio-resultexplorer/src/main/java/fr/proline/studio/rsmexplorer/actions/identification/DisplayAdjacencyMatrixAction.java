...
public class DisplayAdjacencyMatrixAction extends AbstractRSMAction {
    ...
    private void actionImpl(DataSetNode dataSetNode) {
        ...
        if (rsm != null) {
            ...
            // prepare window box
            WindowBox wbox = WindowBoxFactory.getAdjacencyMatrixWindowBox(dataset.getName(), false);
            ...
            final WindowBox wbox = WindowBoxFactory.getAdjacencyMatrixWindowBox(dataset.getName(), false);
