...
public class DefineQuantParamsCompletePanelV2 extends AbstractDefineQuantParamsPanelV2 {
    ...
    public void setQuantParams(Map<String, Object> quantParams) {
        ...
        if (quantParams.containsKey(AbstractDefineQuantParamsPanelV2.ALIGNMENT_CONFIG)) {
            ...
            m_alignmentMethodParameter.setValue((String) alignmentConfig.getOrDefault(AbstractDefineQuantParamsPanelV2.ALIGNMENT_METHOD_NAME, ALIGNMENT_METHOD_VALUES[0]));
