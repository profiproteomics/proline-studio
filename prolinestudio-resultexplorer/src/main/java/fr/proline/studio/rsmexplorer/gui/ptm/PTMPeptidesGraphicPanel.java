 ...
 * @author VD225637
 */
public class PTMPeptidesGraphicPanel extends JPanel  {
    ...
    private final PeptidePane m_peptidePane;
    int m_ajustedLocation;
    private int m_rowCount;
    private int m_sequenceLength;
    private JScrollPane m_scrollPane;
    private PTMPeptidesGraphicView m_ptmSitePanel;
    ...
    public PTMPeptidesGraphicPanel(PanelPeptidesPTMSiteGraphic ctrl, PTMMarkCtrl ctrlMark, ProteinSequenceCtrl ctrlSequence, PeptideAreaCtrl ctrlPeptideArea) {
//        m_ptmSitePanel = ctrl;
