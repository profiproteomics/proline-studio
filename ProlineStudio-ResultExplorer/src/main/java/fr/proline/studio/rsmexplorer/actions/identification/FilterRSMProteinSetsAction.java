...
/**
 * Filters the ProteinSets of all selected ResultSummaries
 * 
 * @author VD225637
 */
public class FilterRSMProteinSetsAction extends AbstractRSMAction{
      
    public FilterRSMProteinSetsAction() {
        super(NbBundle.getMessage(FilterRSMProteinSetsAction.class, "CTL_FilterRSMProteinSetsAction"), AbstractTree.TreeType.TREE_IDENTIFICATION);
    }
