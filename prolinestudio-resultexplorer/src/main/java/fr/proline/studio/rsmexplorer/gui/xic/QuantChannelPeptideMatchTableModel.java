 ...
 * @author JM235353
 */
public class QuantChannelPeptideMatchTableModel extends LazyTableModel implements GlobalTableModelInterface {
    ...
    private static final String[] m_columnNames = {"Id", "Quant. channel", "Peptide", "Score",  "MsQuery", "Rank", "Calc. Mass", "Exp. m/z", "Ppm" , "Charge", "Missed Cl.", "RT","Ion Parent Int.", "PTMs"};
    private static final String[] m_toolTipColumns = {"PSM Id", "Quantitation channel", "Peptide", "Score", "MsQuery", "Rank", "Calculated Mass", "Experimental Mass to Charge Ratio", "parts-per-million" , "Charge", "Missed Clivage", "Retention Time (min)", "Ion Parent Intensity", "Post Translational Modifications"};
