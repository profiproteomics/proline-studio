 ...
 * @author JM235353
 */
public class DefineQuantParamsSimplifiedPanelV2 extends AbstractDefineQuantParamsPanelV2 {
    ...
    public DefineQuantParamsSimplifiedPanelV2(boolean readOnly, boolean readValues) {
        super(readOnly);
