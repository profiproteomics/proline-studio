...
public class DisplayXICPeptideSetAction extends AbstractRSMAction {
    ...
    private void actionImpl(DataSetNode dataSetNode) {
        ...
        WindowBox wbox = WindowBoxFactory.getXicQuantPeptideSetWindowBox(dataset.getName(), dataset.getName() + " Peptides", ((DataSetData) dataSetNode.getData()).getDatasetType().getQuantMethodInfo());
