 ...
 * @author VD225637
 */
public class ComputeQuantProfileTask extends AbstractJMSTask {
    private static final String m_serviceName = "proline/dps/msq/ComputeQuantProfiles";
    ...
    public ComputeQuantProfileTask(AbstractJMSCallback callback, Long projectId,  Long masterQuantChannelId,  Map<String,Object> quantProfileParams, String xicName) {
        super(callback, new TaskInfo("Compute Quantitation Profile for "+xicName, true, TASK_LIST_INFO, TaskInfo.INFO_IMPORTANCE_HIGH));
        m_pId= projectId;
