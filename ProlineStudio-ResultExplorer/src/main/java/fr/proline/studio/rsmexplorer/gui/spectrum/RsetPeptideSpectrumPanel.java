...
public class RsetPeptideSpectrumPanel extends HourglassPanel implements DataBoxPanelInterface {
    ...
    String SPECTRUM_IN_GENERATING = "Generate Spectrum Match in progress...";
    boolean _isSpectrumMatchGenerateAsked = false;
