...
public class DisplayPtmProteinSite  extends AbstractRSMAction {
    ...
    public DisplayPtmProteinSite(AbstractTree.TreeType treeType) {
       super(NbBundle.getMessage(DisplayPtmProteinSite.class, "CTL_PtmProteinSite"), treeType);
    }
    ...
    private void actionImpl(DataSetNode dataSetNode) {
        ...
        if (rsm != null) {
            ...
            // prepare window box
            WindowBox wbox = WindowBoxFactory.getPTMProteinSiteWindowBox(dataSet.getName());
