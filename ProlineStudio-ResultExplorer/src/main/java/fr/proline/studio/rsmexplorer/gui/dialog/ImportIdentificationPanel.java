 ...
 * @author AK249877
 */
public class ImportIdentificationPanel extends JPanel implements InternalPanelInterface {
    ...
    public ImportIdentificationPanel(Window parent) {
        m_parent = parent;

        this.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(), BorderFactory.createTitledBorder("Import Search Results")));

        setMinimumSize(new Dimension(200, 240));

        this.setLayout(new BorderLayout());
        this.add(this.initInternalPanel(), BorderLayout.CENTER);
        ...
        m_addFileButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (m_rootPathError) {
                    ...
                    InfoDialog errorDialog = new InfoDialog(m_parent, InfoDialog.InfoType.WARNING, "Root Path Error", "Server has returned no Root Path for Result Files.\nThere is a problem with the server installation, please contact your administrator.");
                    errorDialog.setButtonVisible(OptionDialog.BUTTON_CANCEL, false);
                    errorDialog.setLocationRelativeTo(m_parent);
                ...
                int result = fchooser.showOpenDialog(m_parent);
    ...
    private JPanel createDecoyPanel() {
        ...
        m_regexButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //HEREPROBLEM
                ImportIdentificationDialog.SelectRegexDialog regexDialog = ImportIdentificationDialog.SelectRegexDialog.getDialog(null, regexArrayList);
    ...
    private boolean checkParametersForOK() {
        ...
        if (nbFiles == 0) {
            ...
            m_dialog.setDialogStatus(true, "You must select a file to import.");
            //highlight(m_fileList);
            m_dialog.highlightPanelComponent(m_fileList);
            return false;
        }
