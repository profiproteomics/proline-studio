...
public class SpectralCountTask extends AbstractServiceTask  {
    ...
    public SpectralCountTask(AbstractServiceCallback callback, DDataset refDataset, List<DDataset> rsmDataset, Long[] quantiDatasetId) {
         super(callback, false /*asynchronous*/, new TaskInfo("Spectral Count on "+refDataset.getName(), true, TASK_LIST_INFO));
    ...
    public boolean askService() {
	    ...
	    params.put("project_id", m_refDataset.getProject().getId());  
            ...
            while (itDataset.hasNext()) {
                ...
                quantChannelParams.put("sampleNumber", Integer.valueOf(number));
                quantChannelParams.put("identResultSummaryId", d.getResultSummaryId());
            ...
            experimentalDesignParams.put("biologicalSamples", biologicalSampleList);
            ...
            biologicalGroupParams.put("sampleNumbers", sampleNumbers);
            biologicalGroupList.add(biologicalGroupParams);
            experimentalDesignParams.put("biologicalGroups", biologicalGroupList);
            ...
            masterQuantChannelParams.put("quantChannels", quantChanneList);
            experimentalDesignParams.put("masterQuantChannels", masterQuantChannelParams);
        ...
        try {
            ...
            if (resultMap != null) {
                ...
                if (success) {
                    ...
                    BigDecimal quantiDatasetIdBD = (BigDecimal) returnedValuesMap.get("data_set_id");
