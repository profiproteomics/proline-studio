...
import fr.proline.studio.gui.ImportResultFilesDialog;
...
//    @Override
    public void runAction() {
        ...
        IResultFileProvider rfProvider  = (IResultFileProvider)JOptionPane.showInputDialog(null, resultFileProviders_type_choose_msg(), resultFileProviders_type_choose_title(), JOptionPane.INFORMATION_MESSAGE, null, rfProviders.toArray(), rfProviders.get(0));
...
//        fchooser.setFileFilter(new FileNameExtensionFilter("Mascot identification result", "dat"));
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, resultFile_import_error_msg(e.getMessage()),error_title(),JOptionPane.ERROR_MESSAGE);
            return;
        }
