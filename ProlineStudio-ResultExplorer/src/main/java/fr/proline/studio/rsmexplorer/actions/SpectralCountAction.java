        ...
        AbstractDatabaseCallback callback = new AbstractDatabaseCallback() {
            ...
            public void run(boolean success, long taskId, SubTask subTask, boolean finished) {
                ...
                if (spectralCountDialog.getButtonClicked() == DefaultDialog.BUTTON_OK) {
                   ArrayList<RSMDataSetNode> selectedDSNodes = spectralCountDialog.getSelectedRSMDSNodeList();
                   //A Voir :) 
...
//                        error = " Spectral Count is not possible on reference Node and some of its child";
    ...
    /*
    public void actionPerformedOLD(RSMNode[] selectedNodes, final int x, final int y) { 
