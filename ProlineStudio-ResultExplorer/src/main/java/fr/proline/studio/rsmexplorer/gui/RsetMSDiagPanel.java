...
public class RsetMSDiagPanel extends HourglassPanel implements DataBoxPanelInterface, ImageExporterInterface  {
	...
	public String m_displayType = "default"; // force display to be default or Pie chart or table etc.
			        		...
			        		if(msOutput != null) {
			        			if(m_displayType.equals("default")) {
									...
									/*case "StackedXYAreaChart":
										MSDiag_StackedXYAreaChart m_msdiagBoxStackedXY = new MSDiag_StackedXYAreaChart();
